                ...
                <div className={styles.contactCards}>
                    ...
                    <div className={styles.contactCardsCard}>
                        <ul className={styles.contactCardsCardList}>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Gmail:</span>
                                <a href="mailto:paragagarwal0589@Gmail.com">paragagarwal0589@gmail.com</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Linked In:</span>
                                <a href="https://www.linkedin.com/in/parag-agarwal-192896219/">Parag Agarwal</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Github:</span>
                                <a href="https://github.com/Parag589">parag589</a>
                            </li>
                        </ul>
                    </div>
                    <div className={styles.contactCardsCard}>
                        <ul className={styles.contactCardsCardList}>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Mobile:</span>
                                <span>+91 6395712243</span>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Whatsapp:</span>
                                <span><a href="https://wa.me/6395712243">+91 6395712243</a></span>
                            </li>
                            {/* <li className={styles.contactCardsCardListItem}>
                                <span>Telegram:</span>
                                <span>+</span>
