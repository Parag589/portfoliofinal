...
import { BsCheck, BsDribbble, BsGithub, BsInstagram, BsLinkedin, BsTwitter, BsWhatsapp } from 'react-icons/bs';
    ...
    return (
        <aside className={classnames(styles.aside, { [styles.asideActive]: asideOpen })}>
            ...
            <div className={styles.asideInformation}>
                ...
                <a href='https://drive.google.com/file/d/1D61ioUCdrNP3Fd2qbl69dUdXbPrpPBUJ/view?usp=drive_link' className={styles.asideInformationCV}>
                    <CgSoftwareDownload />
            ...
            <div className={styles.asideFooter}>
                <a href='https://www.instagram.com/parag_007agarwal/'>
                    <BsInstagram />
                </a>
                <a href='https://github.com/Parag589'>
                    <BsGithub />
                </a>
                <a href='https://www.linkedin.com/in/parag-agarwal-192896219/'>
                    <BsLinkedin />
                </a>
                <a href='https://wa.me/6395712243'>
                    <BsWhatsapp />
                </a>
            </div>
        </aside>
